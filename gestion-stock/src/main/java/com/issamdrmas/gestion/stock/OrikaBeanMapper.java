...
import com.issamdrmas.gestion.stock.dto.UserDto;
...
public class OrikaBeanMapper extends ConfigurableMapper {
    ...
    protected void configure(MapperFactory factory) {
        ...
        registerClassMap(User.class, UserDto.class);
        registerClassMap(Command.class, CommandDto.class);
        registerClassMap(Product.class, ProductDto.class);
